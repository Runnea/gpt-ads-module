export default {
  ...
  mounted() {
    ...
    googletag.cmd.push(() => {
      ...
      const adSlot = (!outOfPage) ? googletag .defineSlot(adUnitPath, this.formattedSize, divId).addService(pubadsService) : googletag.defineOutOfPageSlot(adUnitPath, divId).addService(pubadsService);
